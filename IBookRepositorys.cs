...
public class BookRepository : IBookRepository
{
    ...
    public Task<IEnumerable<Books>> GetBookAsync()
    {
        throw new NotImplementedException();
    }

    public Task<Books> GetBooksAsync(int id)
    {
        throw new NotImplementedException();
    }

    public Task CreateBooksAsync(Books Book)
    {
        throw new NotImplementedException();
    }

    public Task UpdateBooksAsync(Books Book)
    {
        throw new NotImplementedException();
    }
